...
- 스크린샷: `wiki/화면/예약-완료/스크린샷.png` (/bookings/complete?bookingId=booking-confirmed-001)
- 검증 명령: `npm run e2e -- create-booking`

</details>

## 화면 증거
![예약 완료 QA 통과 화면](예약-완료/스크린샷.png)

기획 목업: [예약 완료 기획 목업](예약-완료/목업.html)
