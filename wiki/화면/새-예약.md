...
screenshots:
  - path: wiki/화면/새-예약/스크린샷.png
    alt: 새 예약 QA 통과 화면
    route: /bookings/new?serviceId=consultation
mockups:
  - path: wiki/화면/새-예약/목업.html
    alt: 새 예약 기획 목업
    status: implemented
verify:
...
- 스크린샷: `wiki/화면/새-예약/스크린샷.png` (/bookings/new?serviceId=consultation)
- 검증 명령: `npm run e2e -- create-booking`

</details>

## 화면 증거
![새 예약 QA 통과 화면](새-예약/스크린샷.png)

기획 목업: [새 예약 기획 목업](새-예약/목업.html)
