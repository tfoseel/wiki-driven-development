...
screenshots:
  - path: wiki/자료/스크린샷/화면/booking-detail.png
    alt: 예약 상세 QA 통과 화면
    route: /bookings/booking-confirmed-001
mockups:
  - path: wiki/자료/목업/화면/booking-detail.html
    alt: 예약 상세 기획 목업
    status: implemented
verify:
...
- 스크린샷: `wiki/자료/스크린샷/화면/booking-detail.png` (/bookings/booking-confirmed-001)
- 검증 명령: `npm run e2e -- reschedule-booking`, `npm run e2e -- cancel-booking`

</details>

## 화면 증거
![예약 상세 QA 통과 화면](../자료/스크린샷/화면/booking-detail.png)

기획 목업: [예약 상세 기획 목업](../자료/목업/화면/booking-detail.html)
...
## 기획 목업
- `wiki/자료/목업/화면/booking-detail.html`
