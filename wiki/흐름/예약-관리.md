...
- 산출물: `tests/e2e/reschedule-booking.spec.ts`, `tests/e2e/cancel-booking.spec.ts`, `wiki/흐름/예약-관리/화면트리.png`
- 스크린샷: `wiki/흐름/예약-관리/화면트리.png`
...
```mermaid
flowchart TD
  bookingDetail["예약 상세<br/><img src='../화면/예약-상세/스크린샷.png' width='160' />"]
  bookingRescheduled["일정 변경 후 예약 상세<br/><img src='../화면/예약-상세/스크린샷.png' width='160' />"]
  bookingCanceled["취소 후 예약 상세<br/><img src='../화면/예약-상세/스크린샷.png' width='160' />"]
  bookingBlocked["정책 차단 상태<br/><img src='../화면/예약-상세/스크린샷.png' width='160' />"]
  bookingMissing["찾을 수 없음 상태<br/><img src='../화면/예약-상세/스크린샷.png' width='160' />"]
