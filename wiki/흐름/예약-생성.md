...
- 산출물: `tests/e2e/create-booking.spec.ts`
...
## 화면 트리
- [[screens/service-list]]: 고객이 예약할 서비스를 선택한다.

  ![서비스 목록 QA 통과 화면](../자료/스크린샷/화면/service-list.png)

  - 서비스 선택 -> [[screens/booking-new]]: 슬롯과 연락처를 입력한다.

    ![새 예약 QA 통과 화면](../자료/스크린샷/화면/booking-new.png)

    - 예약 생성 성공 -> [[screens/booking-complete]]: 예약 확정과 캘린더 다운로드 링크를 확인한다.

      ![예약 완료 QA 통과 화면](../자료/스크린샷/화면/booking-complete.png)

    - 슬롯 충돌 또는 입력 검증 실패 -> [[screens/booking-new]] 오류 상태를 보여준다.
