...
- 산출물: `tests/e2e/create-booking.spec.ts`, `wiki/자료/흐름/예약-생성-화면트리.png`
- 스크린샷: `wiki/자료/흐름/예약-생성-화면트리.png`
...
![예약 생성 화면 트리](../자료/흐름/예약-생성-화면트리.png)
...
```mermaid
flowchart TD
  serviceList["서비스 목록<br/><img src='../자료/스크린샷/화면/service-list.png' width='160' />"]
  bookingNew["새 예약<br/><img src='../자료/스크린샷/화면/booking-new.png' width='160' />"]
  bookingComplete["예약 완료<br/><img src='../자료/스크린샷/화면/booking-complete.png' width='160' />"]
  bookingNewError["새 예약 오류 상태<br/><img src='../자료/스크린샷/화면/booking-new.png' width='160' />"]
