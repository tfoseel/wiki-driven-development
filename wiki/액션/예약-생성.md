...
verified_by:
  - src/actions/create-booking.test.ts
  - tests/e2e/create-booking.spec.ts
artifacts:
  - src/actions/create-booking.ts
verify:
  - npm run test -- create-booking
...
- 노드: `actions/create-booking`
- 타입: `action`
- 의존: [[models/booking]], [[models/service]], [[models/availability-slot]]
- 구현: `src/actions/create-booking.ts`
- 검증 파일: `src/actions/create-booking.test.ts`, `tests/e2e/create-booking.spec.ts`
- 산출물: `src/actions/create-booking.ts`
- 스크린샷: 없음
- 검증 명령: `npm run test -- create-booking`, `npm run e2e -- create-booking`
