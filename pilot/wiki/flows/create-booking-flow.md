...
| [[pages/booking-new]] | [[actions/create-booking]] | `serviceId`, `slotId`, 연락처, `customerNote?`, `requestPhoto?` | 액션이 예약, 요청사항, 요청 사진을 저장함 |
| [[pages/booking-new]] | [[pages/booking-complete]] | `bookingId` | 완료 화면이 생성된 예약, 요청사항, 요청 사진을 로드함 |
